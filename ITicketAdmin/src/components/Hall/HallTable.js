                        ...
                        <tbody>
                            {
                                halls.map((hall =>
                                    <tr key={hall.id}>
                                        ...
                                        <td> {hall.address} </td>
                                        <td> {hall.place} </td>
                                        <td><Link to={'/'} className='btn btn-warning'><i class="far fa-edit"></i></Link> <button className='btn btn-danger' onClick={() => deleteHall(hall.id)}> <i className="fas fa-trash-alt"></i></button> </td>
                                    </tr>
                                ))
